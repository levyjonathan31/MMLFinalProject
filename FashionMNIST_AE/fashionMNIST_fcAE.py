...
def main():
    ...
    plt.plot(compression_ratios, training_nrmse_c, label='Training Discovered')
    # make a label on top
    ...
    plt.plot(compression_ratios, test_nrmse_c, label='Test Discovered')
    plt.xlabel('Compression Ratio')
    plt.ylabel('Normalized Root Mean Squared Error')
    plt.show()
    plt.title('Compression Ratio vs. NRMSE Training AE')
    plt.plot(compression_ratios, training_nrmse_d, label='Training AE')
    plt.xlabel('Compression Ratio')
    plt.ylabel('Normalized Root Mean Squared Error')
    plt.show()
    plt.title('Compression Ratio vs. NRMSE Test AE')
    plt.plot(compression_ratios, test_nrmse_d, label='Test AE')
    plt.xlabel('Compression Ratio')
    plt.ylabel('Normalized Root Mean Squared Error')
    plt.show()
    model = Autoencoder(39)
